	...
	SolveMILP : function(rootModel, maxNodes, log) {
		...
		while (unsolvedLPs.length >= 1) {
			...
			if (mostFracIndex == -1) {
				...
				downBranchModel = this.ModelCopy(model);
				...
				upBranchModel = this.ModelCopy(model);
